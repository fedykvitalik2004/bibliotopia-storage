...
public class FileProcessingException extends LocalizedException {
  /**
   * Constructs a new {@code FileProcessingException} with the specified detail message, message
  ...
  /**
   * Constructs a new {@code FileProcessingException} with the specified detail message and message
   * arguments for localization.
   *
   * @param message the detail message or message key for localization
   * @param messageArguments the arguments to be used with the message for localization
   */
  public FileProcessingException(final String message, final Object[] messageArguments) {
