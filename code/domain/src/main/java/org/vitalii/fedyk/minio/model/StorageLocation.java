...
public record StorageLocation(String bucketName, String objectKey) {
   ...
   * This constructor is implicitly called to validate the state of the record fields
   * upon creation. It ensures that both {@code bucketName} and {@code objectKey} are
   * not null and not empty after trimming whitespace.
   *
