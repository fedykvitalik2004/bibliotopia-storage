...
public interface MinIoObjectInfoUseCase {
   ...
   * @return a {@link MinIoObjectInfo} object containing
   ...
   * @return a {@link MinIoObjectInfo} object containing information
   *        about the file, or {@code null} if no file with the given ID exists
   */
